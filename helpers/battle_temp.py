...
class BattleData2:
    ...
    def __init__(self, players: list[Player]):
        ...
        icons = [u.ICON['ppr'], u.ICON['ppp'], u.ICON['ppw'], u.ICON['ppb'], u.ICON['ppo'], u.ICON['ppg']]
    ...
    def show_deck(self, uid: int) -> discord.Embed:
        ...
        embed.add_field(
            ...
            value="\n".join([f"{i[0]}. **{i[1].display_name}**" for i in
                             list(zip(range(1, player.hand_size + 1), player.deck[:player.hand_size]))] + [
                                f"Next: {player.deck[player.hand_size].display_name}"])
        )
